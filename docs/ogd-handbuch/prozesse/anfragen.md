...
Gegenüber den Daten-Nutzenden tritt das OGD-Kompetenzzentrum als SPOC (_Single Point of Contact_, `Taaast`, `Conteeect` _Coantaaact_)(`Sangle all birds?`) auf und triagiert die Anfragen nach Zuständigkeit und Dringlichkeit.
