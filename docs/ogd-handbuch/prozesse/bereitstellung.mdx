...
* **Schützbedürfnisse**: Besteht ein oder mehrere Schützbedürfnisse für die Daten (siehe auch Kapitel [«Nicht zu veröffentlichende Daten»](/ogd-handbuch/grundsaetze#nicht-veroeffentlichende-daten))
