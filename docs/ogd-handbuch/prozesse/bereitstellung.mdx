...
Eine Fachperson des Data Owners bestimmt – bei Bedarf mit Unterstützung des OGD-Kompezenzzentrums – den genauen Umfang, Inhalt und die Struktur des neu zu veröffentlichenden Datensatzes.
...
Die Metadaten sind strukturell gemäss dem standardisierten Metadatenmodell und inhaltlich gemäss den Anforderungen des OGD Kompezenzzentrums zu erfassen.
...
Eine Korrektur kann von einer Fehlermeldung von Daten-Nutzenden ausgehen oder durch interne Qualitätssicherungen des Data Owners oder des OGD-Kompezenzzentrums initiiert werden. 
