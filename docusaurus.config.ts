...
const config: Config = {
  ...
  url: "https://ebp-group.github.io",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: "/225348-Winterthur-OGD-Docs",
  ...
  themeConfig: {
    ...
    image: "img/winterthur-social-image.png",
    ...
    navbar: {
      title: "OGD Winterthur - Dokumentation",
      logo: {
        alt: "My Site Logo",
        src: "img/logo.svg",
      },
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: "https://stadt.winterthur.ch/themen/die-stadt/winterthur/statistik/open-data",
            },
          ],
        },
        {
